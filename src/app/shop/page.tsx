...
export const metadata: Metadata = { title: "Shop All Denim" };
...
function pagHref(
  base: string,
  sp: { category?: string; sort?: string; sizes?: string | string[] },
  page: number
): string {
    ...
    <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12 lg:py-16">
      ...
      <div className="mb-10 lg:mb-12">
        ...
        <h1 className="font-heading font-semibold text-brand-indigo text-4xl lg:text-5xl">
          {activeCategoryName ? activeCategoryName : "Shop All Denim"}
        </h1>
